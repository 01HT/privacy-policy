...
Дата последнего изменения: 01 октября 2018 г. | Версия 1.0.0 ([посмотреть предыдущие версии](https://github.com/01HT/privacy-policy/releases))
...
* пользователей сервисов ООО 01HT - в составе и в сроки, необходимые для осуществления взаимодействия с согласия субъектов персональных данных. В них входит:
